  ...
  return (
    <section id="workshop" className="mx-auto max-w-[1400px] px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
      <div className="grid gap-8 lg:grid-cols-12 items-stretch">
        ...
        <div className="lg:col-span-6 flex flex-col justify-center rounded-3xl bg-neutral-900 p-8 sm:p-12 text-white shadow-2xl border border-neutral-800">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-md border border-neutral-700 bg-neutral-800 px-5 py-3.5 text-xs font-bold uppercase tracking-wider text-white hover:bg-neutral-700 transition-colors"
            >
